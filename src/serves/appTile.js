...
const serveUrl = {
  ...
  getAppListSearch: '/app-manage/v1/query/app_name',
  ...
  k8sMonitor: '/app-manage/v1/app/monitor/'
 ...
 * @param param
 */
export function getK8sMonitor(type, param){
  return axios.get(`${serveUrl.k8sMonitor}${type}?${param}`)
}
...
export function getAppList(param) {
  return axios.get(serveUrl.getAppList + param)
}
 ...
 * @param param
 */
export function getAppListSearch(param) {
  return axios.get(serveUrl.getAppListSearch + param)
}
/**
 * 执行脚本前改变执行状态
 * @param param
