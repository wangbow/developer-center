...
const serveUrl = {
  ...
  sendMain:'/msconsole/web/v1/serviceExplore/sendMail',
  showAppList:'/msconsole/web/v1/app/getAppOwner'


}

export function showAppList() {
  let url2 = serveUrl.showAppList;
  return axios({
    method: 'GET',
    url: url2
  })
 ...
 * @param {*} params 
 */
export function sendMain(params) {
  let url2 = serveUrl.sendMain;
...
export function getRegisterInstance(params) {
  ...
  return axios({
    method: 'GET',
    url: serveUrl.getRegisterInstance + name + `?providerId=${providerId}`
  })
