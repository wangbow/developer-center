...
class ImportModalManager extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Title name="单表模型管理" showBack={false}/>
      <Col md={12}>
        <div className="source-header">
          <div>
            <Link to="/add"><Button colors="primary" shape="squared">新增当前页数据关联</Button></Link>

            <Link to="/HDFS" className="marginLeft10"><Button colors="primary" shape="squared">基础数据抽取</Button></Link>
          </div>
