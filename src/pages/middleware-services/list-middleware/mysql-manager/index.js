...
class ListPage extends Component {
  ...
  managerAuth = (rec) => {
    return (e) => {
      e.stopPropagation();
      verifyAuth('mysql', rec, () => {
        this.context.router.push(`/auth/${rec.insName}?id=${rec.pkMiddlewareMysql}&userId=${rec.userId}&providerId=${rec.providerId}&backUrl=md-service&busiCode=middleware_mysql`);
      })
    }
  }
