...
class ListPage extends Component {
  ...
  managerAuth = (rec) => {
    return (e) => {
      e.stopPropagation();
      verifyAuth('mq', rec, () => {
        this.context.router.push(`/auth/${rec.aliasName}?id=${rec.id}&userId=${rec.userId}&providerId=${rec.providerId}&backUrl=md-service&busiCode=middleware_mq`);
      })
    }
  }
