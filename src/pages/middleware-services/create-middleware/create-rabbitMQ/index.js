...
class CreateMysqlPage extends Component {
    ...
    handleCreateSrv = (evt) => {
        ...
        let { insUsername, databaseName, srvDesc, srvConf, srvVersion = '2.8.19' } = this.state;
    ...
    render() {
        ...
        if (this.state.loading) {
            ...
            return (
                <Row>
                    <div style={{ height: '100%' }} className="mqWraper">
                        <Header widthGoBack="true" router={this.props.router}>
                            <span>创建我的RabbitMQ服务</span>
                        </Header>
