...
class CreateNginxPage extends Component {
    static propTypes = {};
    static defaultProps = {};
    static contextTypes = {};
    ...
    handleCreateSrv = (evt) => {
        ...
        let databBaseNameTrim = this.state.databaseName;
        ...
        let { databaseName, srvDesc, srvConf, srvVersion = '5.6.x' } = this.state;
    ...
    render() {
        ...
        if (this.state.loading) {
            ...
            return (
                <Row style={{ height: '100%' }} className="dclbWraper">
                    <Header widthGoBack="true" router={this.props.router}>
                        <span>创建我的Nginx服务</span>
                    </Header>
