...
class AddScriptModal extends Component{
  ...
  componentWillReceiveProps(nextProps){
    ...
    if(nextProps.showAddCaseModal){
      this.getScripts(`?search_productId=${this.props.app_id}&search_testscriptType=${type}&pageIndex=0&pageSize=5`);
    }
  }
  ...
  handleSelectPage = (eventKey) =>{
    ...
    this.getScripts(`?search_productId=${this.props.app_id}&search_testscriptType=${type}&&pageIndex=${eventKey}&pageSize=5`)
  }
  /**
   * 搜索值
   */
  ...
  handleSearch =() =>{
    ...
    if(searchValue !== ''){
     return this.getScripts(`?search_productId=${this.props.app_id}&search_testscriptType=${type}&pageIndex=0&pageSize=5&search_LIKE__userName=${searchValue}&search_LIKE__productName=${searchValue}&search_LIKE__testscriptName=${searchValue}`);
    }else{
      this.getScripts(`?search_productId=${this.props.app_id}&search_testscriptType=${type}&pageIndex=0&pageSize=5`)
    }
  }
