...
import {getUploadWarInfo, verifyImage, updateAppUpload, getBaseDocker } from 'serves/CI';
                ...
                <FormGroup>
                  ...
                  <Col sm={6} xs={6}>
                    <Select
                      ...
                      {
                        this.state.baseDocker.map((item, index) => {
                          return (
                            <Option value={item.imageName}>{item.imageDisplayName}</Option>
                          )
                        })
                      }
                    </Select>
